    ...
    return (
        <header className="absolute w-full z-50">
            ...
            <motion.div
                ...
                className="md:hidden overflow-hidden bg-white dark:bg-gray-900 px-4 py-5 rounded-lg"
            >
                ...
                <div className="pt-4 border-t border-gray-300 dark:border-gray-700 ">
                    <div className="flex space-x-3">
                        ...
                        <a href="#">
                            <FiUser className="h-4 w-5 text-gray-300" />
                        </a>
    ...
    from-violet-600 to-violet-400 font-bold rounded-xl  hover:from-violet-800 hover:to-purple-700
            ...
            {contactFormOpen && (
                <motion.div
                    ...
                    <div
                        className="p-6 bg-white dark:bg-gray-800 rounded-xl shadow-xl w-full
                    max-w-md">

                        <div className="flex justify-between items-center mb-4">
                            <h1 className="font-bold text-2xl text-gray-300">Get in Touch</h1>
